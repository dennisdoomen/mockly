...
namespace Mockly.Http.ApiVerificationTests;
...
public class ApiApproval
{
    ...
    public Task ApproveApi(string framework)
    {
        ...
        var assemblyFile = SourcePath / "Mockly.Http" / "bin" / configuration / framework / "Mockly.Http.dll";
    ...
    private class TargetFrameworksTheoryData : TheoryData<string>
    {
        ...
        {
            var csproj = SourcePath / "Mockly.Http" / "Mockly.Http.csproj";
