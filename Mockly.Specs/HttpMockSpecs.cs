...
public class HttpMockSpecs
{
    ...
    public class WhenUsingAsyncResponders
    {
        ...
        [Fact]
        public async Task Null_async_responder_throws_argument_null_exception()
        {
            // Arrange
            var mock = new HttpMock();
        ...
        [Fact]
        public async Task Null_async_responder_with_cancellation_token_throws_argument_null_exception()
        {
            // Arrange
            var mock = new HttpMock();
